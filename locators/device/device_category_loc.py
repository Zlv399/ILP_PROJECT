...
class DeviceCategoryLocators:
    ...
    i_devca_name_ele = (By.XPATH, '//*[@id="avue-view"]/div/div[2]/div/div[2]/div/form/div[2]/div[1]/div/div/div[1]/input')
    i_devca_sort_ele = (By.XPATH,'//*[@id="avue-view"]/div/div[2]/div/div[2]/div/form/div[2]/div[3]/div/div/div/div/input')
    ...
    bt_update_devca_ele = (By.XPATH,'/html/body/div[1]/div[1]/div[2]/div[2]/div[3]/div/div/div[2]/div/form/div/div[4]/div[2]/table/tbody/tr[1]/td[6]/div/span[1]')
    #//table/tbody/tr[1]/td[6]/div/span[1]
    t_text_devca_ele = (By.XPATH,'//textarea[@class="el-textarea__inner"]')
    bt_remove_devca_ele = (By.XPATH,'/html/body/div[1]/div[1]/div[2]/div[2]/div[3]/div/div/div[2]/div/form/div/div[4]/div[2]/table/tbody/tr[1]/td[6]/div/span[2]')
